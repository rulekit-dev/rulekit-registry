...
func (s *PostgresStore) ListUsers(ctx context.Context, limit, offset int) ([]*model.User, error) {
	rows, err := s.db.QueryContext(ctx,
...
func (s *PostgresStore) CreateOTPCode(ctx context.Context, otp *model.OTPCode) error {
	_, err := s.db.ExecContext(ctx,
...
func (s *PostgresStore) GetUnusedOTPCode(ctx context.Context, userID string) (*model.OTPCode, error) {
	otp := &model.OTPCode{}
	err := s.db.QueryRowContext(ctx,
...
func (s *PostgresStore) GetAPITokenByHash(ctx context.Context, tokenHash string) (*model.APIToken, error) {
	t := &model.APIToken{}
	var role int
...
func (s *PostgresStore) UpsertUserRole(ctx context.Context, ur *model.UserRole) error {
	_, err := s.db.ExecContext(ctx,
...
func (s *PostgresStore) GetUserRole(ctx context.Context, userID, namespace string) (*model.UserRole, error) {
	ur := &model.UserRole{}
	var mask int
	err := s.db.QueryRowContext(ctx,
...
func (s *PostgresStore) ListUserRoles(ctx context.Context, userID string) ([]*model.UserRole, error) {
	rows, err := s.db.QueryContext(ctx,
